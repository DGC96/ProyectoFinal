 ...
 */
//No puedo usar filter ya que valido la fecha usando preg_match y guardando las partes en un array
...
{
    $aux = filter_var($var, FILTER_VALIDATE_EMAIL);
...
function validaExpresion(&$var, $expresion, $defecto)
{
    ...
    $aux = filter_var($var, FILTER_VALIDATE_REGEXP, $opciones);
