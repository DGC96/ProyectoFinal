...
class CActiveRecord implements Iterator
{
	...
	public function buscarTodosNRegistros($opciones = array())
	{
	...
	public function guardar()
	{
		...
		if (!$this->_esNuevo) {  //se guarda un registro modificado
